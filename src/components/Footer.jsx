...
export default function Footer() {
  return (
    <footer className="bg-[#000000] pt-10 md:pt-20 pb-20 md:pb-52 font-Helix text-white/70 font-heading relative overflow-hidden">
      ...
      <h1 className="absolute left-0 right-0 uppercase font-weight bottom-0 translate-x-[-2%] translate-y-[8%] md:translate-y-[12%] text-[16vw] sm:text-[18vw] md:text-[20vw] lg:text-[18.5vw] font-900 text-white/10 leading-none select-none whitespace-nowrap pointer-events-none text-center">
        Techkrate
      </h1> 

      {/* Main Footer Content */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8 md:gap-10 pb-12 relative z-10">
      ...
      {/* Bottom Strips */}
      <div className="w-full bottom-3 underline px-4 sm:px-6 flex flex-col md:flex-row justify-between items-center text-xs text-white/70 relative z-10 gap-3 sm:gap-0 py-4">
