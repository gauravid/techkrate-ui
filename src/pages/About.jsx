...
//       {/* Hero section with video background and text */}
//       <div
//         ref={canvasContainerRef}
//         className="relative w-full h-screen z-0 flex flex-col items-center justify-center text-center text-white"
//       >
//         <video
...
//         >
//           <h2 className="text-4xl sm:text-6xl md:text-8xl font-Helix self-start left-0 text-white mb-4 whitespace-nowrap">
...
//         <div
//           ref={charterRef}
//           className="relative w-full  px-4 sm:px-8 md:px-16 max-w-7xl mx-auto"
//         >
//           {/* Heading */}
...
//           <div
//             ref={teamHeaderRef}
//             className="text-center py-16 px-4 sm:px-6 md:px-16 text-white"
//           >
...
//       {/* About Us section with fade-in animation and reduced margin */}
//       <div
//         ref={aboutUsSectionRef}
//         className="relative z-10 bg-black -mt-24 sm:-mt-16 md:-mt-12"
//       >
//         <div className="flex flex-col-reverse md:flex-row items-start px-4 sm:px-6 md:px-16 py-16 sm:py-24 max-w-15xl mx-auto text-white">
//           <div className="md:w-3/4 text-base sm:text-lg text-gray-300 leading-relaxed mt-10 md:mt-0">
//             <h1 className="hidden md:block text-8xl text-white md:text-8xl font-Helix mb-8 text-left">
//               About <span className="text-blue-600">Us</span>
//             </h1>
